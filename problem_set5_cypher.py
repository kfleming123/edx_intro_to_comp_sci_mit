...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(len(alpha_lower)):
            try:
                shift_dict[alpha_lower[i]] = alpha_lower[i + shift]
            except:
                shift_dict[alpha_lower[i]] = alpha_lower[i + shift - 26]
        for i in range(len(alpha_upper)):
            try:
                shift_dict[alpha_upper[i]] = alpha_upper[i + shift]
            except:
                shift_dict[alpha_upper[i]] = alpha_upper[i + shift - 26]
        return shift_dict
...
plaintext = PlaintextMessage('hello, World! You are the best:', 0)
a = plaintext.apply_shift(2)
print(a)
